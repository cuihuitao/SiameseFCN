function run_experiment_matvggs5_negative_trainval(imdb_video)
%% Experiment entry point
    ...
    opts.branch.conf.last_layer = 'conv5b';
    opts.branch.type = 'airnet';
    ...
    opts.addAugment.sharpen.flag = 0;
    opts.addAugment.emboss.flag = 0;
    opts.addAugment.invert.flag = 0;
    opts.addAugment.edgeDetect.flag = 0;
    opts.addAugment.dropout.flag = 0;
    opts.addAugment.blur.methods.median.max_kernel_size = 7;
 
    opts.setVALtoTRAIN = true;   % use trainval set to train the net
    
    opts.expDir = 'data/airnet_inverse_0.5_negative_0.5_extraAug_0.5_trainval';
