function net = make_branch_matvggs5_nodilation(varargin)
...
% --------------------------------------------------------------------
function net = create_matvggs5(opts)
    net = dagnn.DagNN();
    lastAdded.var = 'input';
    lastAdded.depth = 3;
    %% conv1 + pool1
    [net, lastAdded] = Conv(net, ...
                            'conv1', 3, 64, lastAdded, opts, ...
                            'relu', true, ...
                            'bias', false, ...
                            'downsample', true);
    ...
    %% conv2 + pool2
    [net, lastAdded] = Conv(net, ...
                            'conv2', 3, 128, lastAdded, opts, ...
                            'relu', true, ...
                            'bias', false, ...
                            'downsample', false);
    %% conv3
    [net, lastAdded] = Conv(net, ...
                            'conv3', 3, 256, lastAdded, opts, ...
                            'relu', true, ...
                            'bias', false, ...
                            'downsample', false);
    %% conv4
    [net, lastAdded] = Conv(net, ...
                            'conv4', 3, 256, lastAdded, opts, ...
                            'relu', true, ...
                            'bias', false, ...
                            'downsample', false);   
    %% conv5
